...
const incompleteTaskHolder = document.querySelector(".undone__tasks__block"); //ul of #incompleteTasks
const completedTasksHolder = document.querySelector(".done__tasks__block"); //completed-tasks

//New task list item
const createNewTaskElement = function (taskString) {

  let listItem = document.createElement("li");
  listItem.classList.add("tasks__block_element");
  ...
  editInput.classList.add("task", "input__text");
  //button.edit
...
const editTask = function () {
  ...
  let editInput = listItem.querySelector(".input__text");
...
const bindTaskEvents = function (taskListItem, checkBoxEventHandler) {
  ...
  let checkBox = taskListItem.querySelector(".input__checkbox");
